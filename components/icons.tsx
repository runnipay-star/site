...
export const CashIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.75A.75.75 0 013 4.5h.75m0 0a.75.75 0 01.75.75v.75m0 0a.75.75 0 01-.75.75h-.75m9-6h.008v.008H12V4.5h.008v.008H12V4.5zm.008 0a.75.75 0 01.75.75v.75m0 0a.75.75 0 01-.75.75h-.75m-6 0h.008v.008H6V6h.008v.008H6V6zm.008 0a.75.75 0 01.75.75v.75m0 0a.75.75 0 01-.75.75H6m6 0h.008v.008H12V9h.008v.008H12V9zm.008 0a.75.75 0 01.75.75v.75m0 0a.75.75 0 01-.75.75h-.75m-6 0h.008v.008H6v-.008H6V9zm.008 0a.75.75 0 01.75.75v.75m0 0a.75.75 0 01-.75.75H6m9 0h.008v.008H15v-.008H15V9zm.008 0a.75.75 0 01.75.75v.75m0 0a.75.75 0 01-.75.75h-.75m-6 0h.008v.008H9v-.008H9V9zm.008 0a.75.75 0 01.75.75v.75m0 0a.75.75 0 01-.75.75H9m9 0h.008v.008H18v-.008H18V9zm.008 0a.75.75 0 01.75.75v.75m0 0a.75.75 0 01-.75.75h-.75m-6 0h.008v.008H12v-.008H12V9z" />
    </svg>
);
